 ...
 * @version V1.0
 */
public abstract class AbstractSecurityCodeVerifyFilter<D, R> extends OncePerRequestFilter {
     ...
     * @return 验证码处理器
     */
    protected abstract SecurityCodeHandler<D, ? extends SecurityCode<D>, R> getSecurityCodeHandler();
     ...
     * @return 仓库
     */
    protected abstract R getRepository(HttpServletRequest request);
