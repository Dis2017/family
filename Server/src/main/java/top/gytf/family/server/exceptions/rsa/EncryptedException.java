package top.gytf.family.server.exceptions.rsa;

import top.gytf.family.server.response.StateCode;
import top.gytf.family.server.response.StatusCarrier;

/**
 * Project:     IntelliJ IDEA<br> Description: 加密错误<br> CreateDate:  2021/12/19 0:00 <br>
 * ------------------------------------------------------------------------------------------
 *
 * @author user
 * @version V1.0
 */
@StatusCarrier(code = StateCode.ENCRYPTED_EXCEPTION)
