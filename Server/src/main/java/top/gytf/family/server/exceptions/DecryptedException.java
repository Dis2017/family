...
/**
 * Project:     IntelliJ IDEA<br> Description: 解密错误<br> CreateDate:  2021/12/18 23:55 <br>
 * ------------------------------------------------------------------------------------------
 *
 * @author user
 * @version V1.0
 */
@StatusCarrier(code = StateCode.DECRYPTED_EXCEPTION)
public class DecryptedException extends RuntimeException{
	 ...
	 *                method.
	 */
	public DecryptedException(String message) {
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public DecryptedException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public DecryptedException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @since 1.7
	 */
	public DecryptedException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
