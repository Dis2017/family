 ...
 * Description: 空参数错误<br>
 * CreateDate:  2021/12/18 22:16 <br>
 * ------------------------------------------------------------------------------------------
 *
 * @author user
 * @version V1.0
 */
@StatusCarrier(code = StateCode.PARAM_IS_BLANK)
public class EmptyParamException extends RuntimeException{
    private final static String TAG = EmptyParamException.class.getName();
